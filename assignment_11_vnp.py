...
Original file is located at
    https://colab.research.google.com/drive/1vUnKeqyEJBeDLhRWDXE_8X7KZZgIfBw5
"""

# Initialize variables
pollution_level = 15  # Initial pollution level
pollution_increase_rate = 8  # Rate of pollution increase per minute
purifier_rate = 3.5  # Rate of purification per minute
simulation_duration = 35  # Duration of the simulation in minutes
